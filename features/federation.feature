Feature: Dynamicity
  ...
  Background: dataClay deployment
    Given "UserA" has a configuration file "resources/federation/machine-a/cfgfiles/client.properties" to be used to connect to dataClay
      ...
      And "UserB" registers external dataClay named "dataClayA" with hostname "localhost" and port 12034
      And "UserB" imports models in namespace "test_namespace" from dataClay named "dataClayA"
      And "UserB" get stubs from namespace "test_namespace" into "stubs" directory
